...
return [
    ...
    'directory_list' => [
        ...
        'vendor/behat/behat/src/Behat/Behat',
        'vendor/behat/behat/src/Behat/Testwork',
        'vendor/behat/mink-browserkit-driver/src',
        'vendor/behat/mink/src',
        'vendor/bensampo/laravel-enum/src',
        'vendor/beyondcode/laravel-dump-server/src',
        'vendor/brainmaestro/composer-git-hooks/src',
        'vendor/dmore/behat-chrome-extension/src',
        'vendor/dmore/chrome-mink-driver/src',
        'vendor/doctrine/dbal/lib/Doctrine/DBAL',
        'vendor/facade/ignition/src',
        'vendor/fideloper/proxy/src',
        'vendor/filp/whoops/src/Whoops',
        'vendor/friends-of-behat/mink-extension/src',
